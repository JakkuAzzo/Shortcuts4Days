...
def insert_records():
    ...
    try:
        ...
        for i in range(num_records):
            ...
            query = f"INSERT INTO {table_name} VALUES ('{user_id}','{name}', '{address}', '{email}', '{phone_number}', {age}, '{passport_number}')"
            cursor.execute(query)

            print("current record contains:",user_id, name, address, email, phone_number, age, passport_number)
